...
class Ufo:
    ...
    def __init__(self, name, x, y, size, color, color_pillars, color_lamps, color_circle,
                 count_pillars, count_lamps, speed=1, pillars_down=True, show_name=True,
    ...
    def show(self, move_x=0, move_y=0):
    ...
    """def not_show(self):
        colors = [self.color, self.color_pillars, self.color_circle, self.color_lamps]
        self.color = self.color_pillars = self.color_circle = self.color_lamps = 'white'

        # self.show()
        tr.clear()
        self.color = colors[0]
        self.color_pillars = colors[1]
        self.color_circle = colors[2]
        self.color_lamps = colors[3]"""

    def move(self):
        self.show(randint(-1, 1), randint(-1, 1))
